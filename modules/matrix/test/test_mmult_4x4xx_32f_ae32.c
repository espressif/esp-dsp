...
static const char *TAG = "dslm_mult_4x4x1_32f_ae32";

TEST_CASE("dslm_mult_4x4x1_32f_ae32 functionality", "[dslm]")
{
    int m = 4;
    int n = 4;
    int k = 1;
...
TEST_CASE("dslm_mult_4x4x4_32f_ae32 functionality", "[dslm]")
{
    int m = 4;
    int n = 4;
    int k = 4;
...
TEST_CASE("dslm_mult_4x4x1_32f_ae32 benchmark", "[dslm]")
{
    int m = 4;
    int n = 4;
    int k = 1;
...
TEST_CASE("dslm_mult_4x4x4_32f_ae32 benchmark", "[dslm]")
{
    int m = 4;
    int n = 4;
    int k = 4;
