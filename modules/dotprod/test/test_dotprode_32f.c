...
TEST_CASE("DSL check dsls_dotprode_32f_ae32 functionality", "[dsl]")
{
...
TEST_CASE("DSL check dsls_dotprode_32f_ae32 benchmark", "[dsl]")
{
    int max_N = 1024;
    float* x = (float*)malloc(max_N*sizeof(float));
    float* y = (float*)malloc(max_N*sizeof(float));
...
TEST_CASE("DSL check dsls_dotprode_32f_ansi functionality", "[dsl]")
{
    float check_value = 1235;
    int max_N = 1024;
    float* x = (float*)malloc(max_N*sizeof(float));
...
TEST_CASE("DSL check dsls_dotprode_32f_ansi benchmark", "[dsl]")
{
    int max_N = 1024;
    float* x = (float*)malloc(max_N*sizeof(float));
    float* y = (float*)malloc(max_N*sizeof(float));
